...
func (t *Tree) newDummy(pos Pos, line int) *DummyNode {
	return &DummyNode{tr: t, NodeType: NodeContinue, Pos: pos, Line: line}
}

func (c *DummyNode) Copy() Node                  { return c.tr.newDummy(c.Pos, c.Line) }
func (c *DummyNode) String() string              { return "{{dummy}}" }
func (c *DummyNode) tree() *Tree                 { return c.tr }
func (c *DummyNode) writeTo(sb *strings.Builder) { sb.WriteString("{{dummy}}") }
